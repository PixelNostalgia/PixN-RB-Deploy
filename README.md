...
3. Place the deploy script file in the root of the RetroBat folder.

4. Double-click the deploy script to run it.

5. Wait.......make a drink etc...

6. When the script has finished, check the "- PixN_ReadMe.txt" in the root of the RetroBat folder.

7. Download any additional ROMpacks you want: https://pixelnostalgia.github.io/

8. Launch RetroBat and run the 'PixN Update Service' from the RetroBat item on the wheel.
